...
function [ posDesired, UxDesired, AxDesired, AxMax] = FindSpeedProfileForSegment(path, veh, mu, Vmax, sigma,...
    ...
    %    NO OPEN MAP CAPABILITY RIGHT NOW
    ...
    %     end
    x_0 = [path.v_0 ;    path.a_0];% ; path.beta_0];
    x_end = [path.v_end ;     path.a_end];


    [posDesired,UxDesired,AxDesired,AxMax] = GenerateSpeedProfileForSegment(speedLim,AxDesired,veh,mu,sigma,Fv2,G,Mv2,Mvdot,theta, jerkLimit,brakeFactor,x_0,x_end);
