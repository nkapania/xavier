...
load LScenter.mat; refWorld.isOpen = 0;  %Just load the centerline path since it has been modified to be continuous
bounds = load('laguna_seca_bounds.mat');
...
%qW = shiftWorld(genWorldFromCSV('C:\Mapping\Maps\Thunderhill West\ThillWest_1m.csv'), 930);
