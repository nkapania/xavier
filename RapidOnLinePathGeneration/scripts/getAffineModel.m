...
FzF = veh.FzF; FzR = veh.FzR; muP = veh.muP; muS = veh.muS; xLA = veh.xLA; kLK = veh.kLK ;

%k1 = kLK; k2 = xLA*kLK;      %Note: In optimization, we don't want
%feedback acting.
k1 = 0; k2 = 0;

FyFhat = tireforces(Cf, muP, muS, afHat, FzF);
FyRhat = tireforces(Cr, muP, muS, arHat, FzR);
Cf = getLocalStiffness(afHat, Cf, muP, muS, FzF);
Cr = getLocalStiffness(arHat, Cr, muP, muS, FzR);
