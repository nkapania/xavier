function [s, Fv2, G, Mv2, Mvdot, theta] = MakePath3D(path, topoData,ds,Iz)
...
totalLength = path.s(end);
s = linspace(0,totalLength,round(totalLength/ds));
...
[psi, dpsi_dsigma, d2psi_dsigma2] = CalcHeadingData(path,s);
