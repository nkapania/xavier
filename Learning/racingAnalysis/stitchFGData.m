...
f1 = load('C:\Users\ddl\Documents\localTestData\2015 6 24 FastMapGen\fullautomu90FG_2015-06-23_ab.mat');
f2 = load('C:\Users\ddl\Documents\localTestData\2015 6 24 FastMapGen\unmannedmu90FG_2015-06-24_ab.mat');
f3 = load('C:\Users\ddl\Documents\localTestData\2015 6 24 FastMapGen\unmannedmu90FG_2015-06-24_aa.mat');
f4 = load('C:\Users\ddl\Documents\localTestData\2015 6 24 FastMapGen\fullautomu90FG_2015-07-21_aa.mat');


%%

ind0 = find(f4.mapMatch.s_m > 811   & f4.mapMatch.s_m < 1573);
ind1 = find(f1.mapMatch.s_m > 1573 & f1.mapMatch.s_m < 2046);
ind2 = find(f2.mapMatch.s_m > 2046  & f2.mapMatch.s_m < 4270);
ind3 = find(f3.mapMatch.s_m > 4270);
ind4 = find(f3.mapMatch.s_m < 741 & f3.mapMatch.s_m > 0);
...
%%
save('C:\Users\ddl\Documents\localTestData\2015 6 24 FastMapGen\mu90fgStitch','t','mapMatch','OxTSData','calc','tireSlip','TTSdata','HLlongitudinal');